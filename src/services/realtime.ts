...
export class RealtimeSession {
  ...
  private sendAwareness: ((data: Record<string, unknown>) => Promise<void[]>) | null = null
  ...
  setLocalAwareness(activeFile: string | null, focusedBlock: number | null): void {
  ...
  private mapEntryToComment(id: string, raw: Record<string, unknown>): PeerComment | null {
